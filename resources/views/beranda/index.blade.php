...
@section('content')
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 sm:p-10 min-h-[500px]">
        ...
        <div class="mb-10">
            ...
            <h3 class="text-3xl sm:text-4xl font-extrabold text-gray-800 mt-1">Gita Hasna Sutarto</h3>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="bg-indigo-500 text-white rounded-2xl p-6 flex flex-col justify-between gap-6 shadow-lg relative overflow-hidden group">
                ...
                <button class="relative z-10 bg-white text-indigo-500 font-bold py-3 px-4 rounded-xl w-full text-center hover:bg-indigo-50 transition shadow-md">CUTI & IZIN</button>
            </div>

            {{-- Card 3: Riwayat --}}
            <div class="bg-indigo-500 text-white rounded-2xl p-6 flex flex-col justify-between gap-6 shadow-lg relative overflow-hidden group">
                <div class="absolute -right-4 -bottom-4 opacity-20 transform group-hover:scale-110 transition duration-300">
                        <svg class="h-32 w-32" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                </div>
                <div class="relative z-10">
                    <p class="font-medium text-indigo-100 text-sm">Log Aktivitas</p>
                    <p class="font-bold text-xl mt-1">Cek Riwayat Kehadiran?</p>
                </div>
                <button class="relative z-10 bg-white text-indigo-500 font-bold py-3 px-4 rounded-xl w-full text-center hover:bg-indigo-50 transition shadow-md">LIHAT RIWAYAT</button>
            </div>
        </div>
    </div>
@endsection