...
@section('content')
        ...
        >
            ...
            @if (!$sudahMasuk)
                <div class="mb-8">
                    ...
                    <input id="bukti_foto" name="bukti_foto" type="file" accept="image/*"  capture="environment" class="hidden" required>
                    ...
                    >
                        <svg class="h-8 w-8 text-gray-400 group-hover:text-[#6379F1] transition" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="flex items-center gap-3">
                        <div class="w-28 h-28 border border-gray-200 rounded-lg overflow-hidden bg-gray-50 flex items-center justify-center">
                            @if (!empty($absenHariIni->bukti_foto))
                                <img src="{{ asset('storage/' . $absenHariIni->bukti_foto) }}" class="w-full h-full object-cover" alt="Bukti Kehadiran">
                            @else
    ...
    {{-- Script: tampilkan nama file yang dipilih --}}
    <script>
        (function () {
